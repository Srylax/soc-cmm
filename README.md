...
- MS Excel (not a big fan, sorry)
- Doesn't work on Linux (because Excel doesn't, alternatives don't work)
- Slugish (also an Excel issue)

## Features / Improvements of the Web edition

- Modern UI (including dark mode)
- Saved as TOML, which allows tracking progress in a VCS
- Search
- Inline comments
- Bookmarks
