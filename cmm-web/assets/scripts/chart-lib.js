...
!(function (t, e) {
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === h &&
            ...
            t.save(),
            fa(t, s, a.bottom));
        ga(t, { line: i, target: s, color: o, scale: r, property: h, clip: l }),
          t.restore();
      })(t, {
        line: a,
        target: s,
  ...
  function ga(t, e) {
    ...
    for (const { source: e, target: h, start: c, end: d } of l) {
      const { style: { backgroundColor: l = o } = {} } = e,
        u = !0 !== s;
      t.save(), (t.fillStyle = l), pa(t, a, r, u && ea(n, c, d)), t.beginPath();
  ...
  class Ba extends $s {
    ...
    getTitle(t, e) {
      ...
      let a = [];
      return (a = Da(a, Ca(s))), (a = Da(a, Ca(n))), (a = Da(a, Ca(o))), a;
    }
    getBeforeBody(t, e) {
